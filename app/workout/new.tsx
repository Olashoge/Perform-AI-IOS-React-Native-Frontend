  ...
  const handleSubmit = async () => {
    ...
    const payload: any = {
      preferences: {
        ...
        focusAreas,
        daysOfWeek,
        sessionDurationMinutes: sessionLength,
...
const createStyles = (Colors: ThemeColors) => StyleSheet.create({
  ...
  pillTextSm: { fontSize: 12, fontFamily: "Inter_500Medium", color: Colors.textSecondary },
  ...
  equipmentCategoryTitle: { fontSize: 13, fontFamily: "Inter_600SemiBold", color: Colors.textSecondary },
  bottomBar: {
